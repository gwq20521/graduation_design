 ...
 * emp_friend_info insert 增加数据,
 * emp_friend_info delete 删除数据,
 * emp_friend_info update 修改数据,
 * emp_friend_info select 查询数据,
 * emp_friend_info export 导出数据,
 * emp_friend_info import 导入数据
 * @since ${.now}
 */
@Controller
...
public class EmpFriendInfoController {
     ...
     * @param emp_friend_info json 数据对象
     * @param model spring model 操作
     * @param request 请求数据
     * @return ReturnData 通用数据对象
     */
