 ...
 * jobs_manage insert 增加数据,
 * jobs_manage delete 删除数据,
 * jobs_manage update 修改数据,
 * jobs_manage select 查询数据,
 * jobs_manage export 导出数据,
 * jobs_manage import 导入数据
 * @since ${.now}
 */
@Controller
