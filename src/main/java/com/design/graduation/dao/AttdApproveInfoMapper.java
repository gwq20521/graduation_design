...
public interface AttdApproveInfoMapper {
     ...
     * @param attdApproveInfo
     */
    List<AttdApproveInfo> selectData(@Param("attdApproveInfo") AttdApproveInfo attdApproveInfo,
     ...
     * @param attdApproveInfo
     */
    List<Map<String, Object>> selectRelationData(@Param("attdApproveInfo") AttdApproveInfo attdApproveInfo,
            @Param("limit") int limit, @Param("offset") int offset, @Param("order_by") String order_by);
     ...
     * @param attdApproveInfo
     */
    List<AttdApproveInfo> selectByParam(@Param("attdApproveInfo") AttdApproveInfo attdApproveInfo,
