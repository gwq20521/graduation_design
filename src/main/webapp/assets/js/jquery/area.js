...
var s=["s_county","s_township","s_village"];//三个select的name
var opt0 = ["县","乡","村"];//初始值
...
var showArea = function(){
	...
	Gid('show').innerHTML = "<h3>省" + Gid('s_county').value + " - 县" +

		Gid('s_township').value + " - 乡/镇" +

		Gid('s_village').value + "</h3>"

};

Gid('s_village').setAttribute('onchange','showArea()');
//------------调用------------------------end
