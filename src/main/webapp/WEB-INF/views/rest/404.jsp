	...
	<div class="container-fluid">
		<div class="row" style="padding-top:100px;">
		    <div class="col-xs-8 col-xs-offset-2">
		    	<img src="<%=path %>/assets/image/404.png" class="img-responsive center-block"/>
		    </div>
		    <div class="col-xs-8 col-xs-offset-2">
		    	<p style="font-size: 20px;text-align: center;color: black;padding-top:20px;">未知错误，找不到页面啦，请返回首页！</p>
		    </div>
