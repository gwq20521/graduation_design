...
var attd_approve_infoParam = {};
	...
	$("#id").val(olddata.id);
	$("#approveDays").val(olddata.approveDays);
	$("#approveContent").val(olddata.approveContent);
	$("#approveRemark").val(olddata.approveRemark);
	$("#approveTimeStart").val(getFormatDate(olddata.approveTimeStart));
	$("#approveTimeEnd").val(getFormatDate(olddata.approveTimeEnd));
	...
	$("#save").click(function(){
	    ...
	    $.ajax({url:'<%=path %>/attd_approve_info/update',
       		type:'post',
       		cache:false,
       		dataType:'json',
